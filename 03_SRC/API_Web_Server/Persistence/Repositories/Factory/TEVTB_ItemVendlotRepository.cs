...
using API_Web_Server.Helper.Barcode;
using API_Web_Server.Helper.PDF;
using API_Web_Server.Helper.Printting;
...
namespace API_Web_Server.Persistence.Repositories.Factory
{
